...
HD_PWD='/home/administrateur/vhdl2_ual/vhdl2_ual.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Arty_Digilent_TopLevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Arty_Digilent_TopLevel.tcl -notrace
