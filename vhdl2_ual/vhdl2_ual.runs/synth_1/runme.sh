...
HD_PWD='/home/administrateur/vhdl2_ual/vhdl2_ual.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Arty_Digilent_TopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Arty_Digilent_TopLevel.tcl
