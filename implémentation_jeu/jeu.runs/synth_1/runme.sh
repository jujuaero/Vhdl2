...
HD_PWD='/home/administrateur/jeu/jeu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_logigame.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_logigame.tcl
