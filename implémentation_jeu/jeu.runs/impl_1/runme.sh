...
HD_PWD='/home/administrateur/jeu/jeu.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_logigame.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_logigame.tcl -notrace
